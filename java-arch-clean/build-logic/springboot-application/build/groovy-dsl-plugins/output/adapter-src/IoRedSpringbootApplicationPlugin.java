...
/**
 * Precompiled io.red.springboot-application script plugin.
 **/
public class IoRedSpringbootApplicationPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_IoRedSpringbootApplication").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("io.red.commons");
            target.getPluginManager().apply("org.springframework.boot");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_IoRedSpringbootApplication").asSubclass(BasicScript.class);
